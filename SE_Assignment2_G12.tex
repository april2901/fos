...
The overall system architecture is illustrated in Figure 1. The diagram shows the flow of data from user input through the frontend (React), backend (API Routes), external services (Gemini), and database (Supabase/PostgreSQL).
